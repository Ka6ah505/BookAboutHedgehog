...
local function onPageSwap( event )
    ...
    elseif event.phase == "ended" or event.phase == "cancelled" then
    	...
    	if distance > swipeThreshNext then
	    	storyboard.removeScene( "pages.page2" )
			storyboard.gotoScene( "pages.page3", "fade", 400  )
		elseif distance < swipeThreshPrev and distance < 0 then
			storyboard.removeScene( "pages.page2" )
			storyboard.gotoScene( "pages.page1", "zoomInOut", 400  )
	    end
...
function scene:createScene( event )
	...
	background = display.newImageRect( "images/3.jpg", display.contentWidth, display.contentHeight)
