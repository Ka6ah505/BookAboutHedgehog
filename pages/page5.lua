...
local function onPageSwap( event )
    ...
    elseif event.phase == "ended" or event.phase == "cancelled" then
    	...
    	if distance > swipeThreshNext then
	    	storyboard.removeScene( "pages.page5" )
			storyboard.gotoScene( "pages.page6", "fromTop", 400  )
		elseif distance < swipeThreshPrev and distance < 0 then
			storyboard.removeScene( "pages.page5" )
			storyboard.gotoScene( "pages.page4", "fromBottom", 400  )
	    end
...
function scene:createScene( event )
	...
	background = display.newImageRect( "images/6.jpg", display.contentWidth, display.contentHeight)
