...
local function onPageSwap( event )
    ...
    elseif event.phase == "ended" or event.phase == "cancelled" then
    	...
    	if distance > swipeThreshNext then
	    	storyboard.removeScene( "pages.page12" )
			storyboard.gotoScene( "pages.page13", "slideDown", 400  )
		elseif distance < swipeThreshPrev and distance < 0 then
			storyboard.removeScene( "pages.page12" )
			storyboard.gotoScene( "pages.page11", "slideUp", 400  )
	    end
...
function scene:createScene( event )
	...
	background = display.newImageRect( "images/13.jpg", display.contentWidth, display.contentHeight)
